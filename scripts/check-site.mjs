...
const styles=(await Promise.all(['styles.css','assets/experience.css','assets/product-media.css','assets/swipe.css'].map(path=>readFile(resolve(root,path),'utf8')))).join('\n');
