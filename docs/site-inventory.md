...
Inventaire vérifié sur les sorties locales de la refonte du 14 septembre 2026. Chaque dépôt reste
...
| Petites Gouttes | `bnjdpn/petites-gouttes` | `marketing/site.json`, `site.html.erb`, `theme.css`, `legal/` → `docs/` | en-GB, en-US, fr-FR | 12 | [Site](https://bnjdpn.github.io/petites-gouttes/) |
...
Les 16 sites Ruby ont des compositions produit distinctes, avec captures,
contenu localisé, description/aide et support. Les FAQ et pages auxiliaires
suivent les besoins du produit ; leur présence n’est pas systématisée. Les pages juridiques
...
Les captures proviennent des interfaces natives documentées ou des fiches Apple
publiques. Leurs métadonnées datent les sources ; une ancienne version n’est
pas une preuve de dernière disponibilité. `marketing/site.json` et chaque
`marketing/README.md` décrivent les mappings et contrôles. PRVault a été
ramené à sa version publique 1.4.0 et Petites Dents actualisé depuis la 2.1.0
publique. Les langues et le fond juridique sont conservés. La décision
éditoriale du 10 septembre reste historique et ne remplace pas une lecture
publique distincte de chaque plateforme.
...
## État de cette refonte

Les 18 sites représentent 367 routes HTML générées. Le guide d’impression de
Petites Gouttes explique l’écart de trois routes avec l’ancien inventaire.
Le [rapport](redesign-20260914.md) distingue validations locales, échantillons
visuels et limites. Les nouveaux contrôles reproductibles sont décrits dans
le [README](../README.md#local-ecosystem-review). Aucun push ou déploiement de
cette refonte n’a été effectué.
